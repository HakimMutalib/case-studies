...
if (isset($_POST["chkout"])) {
  ...
  echo '<script>alert("Time of checkout : '.date('Y-m-d H:i:s').' and total price is : '$totaltax'")</script>';
}
          ...
          <div class="container" style="width:700px;">
               ...
               <div class="table-responsive">
                    <table class="table table-bordered">
                         ...
                         <?php //Discount calculation and preview
